...
# Главный заголовок
echo -e "\n\033[1;35m======================================="
echo " Настройка рабочего пространства unitree_h1_teleoperaion_ws "
echo -e "=======================================\033[0m"
...
target_path="../../../.."
mkdir -p "$target_path/unitree_h1_teleoperation_ws/src" || print_error "Ошибка создания директорий"
cd "$target_path/unitree_h1_teleoperation_ws/src" || print_error "Ошибка перехода в директорию"
